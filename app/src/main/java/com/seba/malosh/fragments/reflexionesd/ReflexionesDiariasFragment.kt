package com.seba.malosh.fragments.reflexionesd
...
class ReflexionesDiariasFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        requireActivity().onBackPressedDispatcher.addCallback(viewLifecycleOwner, object : OnBackPressedCallback(true) {
            override fun handleOnBackPressed() {
                ...
                intent.putExtra("reflexionesList", ArrayList(reflexionesList))
    ...
    private fun guardarReflexion() {
        ...
        if (reflexion.isNotEmpty()) {
            ...
            reflexionesList.add(claveReflexion)
            listaReflexionesAdapter.notifyDataSetChanged()
        } else {
